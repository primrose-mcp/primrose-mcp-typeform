 ...
 *
 * Custom error classes and error handling helpers for Typeform API.
 */

/**
 * Base Typeform API error
 */
 ...
 * Typeform API allows 2 requests per second per account
 */
export class RateLimitError extends TypeformApiError {
 ...
 */
export class AuthenticationError extends TypeformApiError {
 ...
 * Not found error
 */
export class NotFoundError extends TypeformApiError {
 ...
 * Validation error
 */
export class ValidationError extends TypeformApiError {
